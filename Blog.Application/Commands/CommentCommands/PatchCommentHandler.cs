...
public class PatchCommentHandler(ICommentRepository repository, IMapper mapper) : IRequestHandler<PatchCommentCommand, CommentDto>
{
    public async Task<CommentDto> Handle(PatchCommentCommand request, CancellationToken cancellationToken)
    {
       ...
       exisitngComment.UpdatedAt = DateTime.UtcNow;
        ...
        {
            Title = exisitngComment.Title,
            Content = exisitngComment.Content,
        };
        return dto;
    }
}
